...
export const cohorts = [
  {
    ...
    gen: '169기', start: '2026-09-06', end: '2027-02-21', cls: '일요반', status: 'open', note: '잔여 1자리',
    off: ['2026-09-27', '2026-10-04', '2027-02-07'], // 추석·개천절·설날
    special: {
      '2026-11-15': '자체 스터디',   // 그룹레슨 실습·해부학/동작 스터디·1:1 티칭실습·자율 수련
      '2026-11-22': '중간고사',      // 중간고사·동작 테스트·시험대비 + 필라테스 측정평가
      '2026-12-27': '자체 스터디',
      '2027-01-31': '자체 스터디',
      '2027-02-14': '기말고사',      // 기말고사(실기) + 그룹수업발표
      '2027-02-21': '프로필 촬영일', // 마지막 실기동작 복습 + Dress-up & Photoshooting day
    },
    extra: [
      { date: '2027-02-28', title: '필기시험' }, // 이론시험: 수업종료 ~7일
      { date: '2027-03-21', title: '실기시험' }, // 실기시험: 수업종료 ~30일
    ],
  },
  {
